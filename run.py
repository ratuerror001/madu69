 ...
 #--- methode 2
	...
	def UA(self):
		try:
			...
			uas = ("Mozilla/5.0 (Linux; U; Android 6.0.1; OPPO A57 Build/MMB29M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/95.0.4638.74 Mobile Safari/537.36 OPR/83.0.2254.73002")
			open('ugent.txt','w').write(uas)
