...
def menu():
	...
	if romz in ['']:print ("\n ! jangan kosong")
		...
		if us in['no','No','NO']:
			...
			uas = ("Mozilla/5.0 (Linux; Android 4.1.2; Nokia_XL Build/JZO54K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/30.0.1599.82 Mobile Safari/537.36 NokiaBrowser/1.0.1.54")
